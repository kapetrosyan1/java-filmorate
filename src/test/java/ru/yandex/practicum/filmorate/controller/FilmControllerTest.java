...
public class FilmControllerTest {
    ...
    void createFilmTest() {
        Film film1 = new Film(1, "TestFilm1", "TestFilm1Description",
                LocalDate.of(1996, 11, 3), 120, new TreeSet<>(), new HashSet<>(), null);
    ...
    void filmValidationTest() {
        ...
        Film film3 = new Film(0, "TestFilm3", "TestFilm3Description",
                LocalDate.of(1815, 11, 3), 120, new TreeSet<>(), new HashSet<>(), null);
        Film film4 = new Film(0, "TestFilm4", "TestFilm4Description",
                LocalDate.of(1996, 11, 3), 0, new TreeSet<>(), new HashSet<>(), null);
